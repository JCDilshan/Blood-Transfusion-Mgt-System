...
$doc_id = isset($_REQUEST['doc_id']) ? base64_decode($_REQUEST['doc_id']) : '';

$result = $doctor_object->get_Specificdoctor($doc_id);
...
<body>
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            <div class="card-header text-center bg-dark">
              <i class="fa fa-user-tie fa-3x fa-pull-left" style="color:#FFF;"></i><i class="fa fa-edit fa-3x fa-pull-left" style="color:#FFF;"></i> <span style="font-size:28px; color:#FFF; letter-spacing:5px;"><b>Update Doctor Details</b></span>
            </div>
            <div class="card-body">
              <!--Reg Form Start-->
              <form id="editDocForm" action="../controller/staff_controller.php?status=update_doctor&doc_id=<?php echo $doc_id; ?>" method="post">

                <h4>Profile Status - <?php $status = $row['doc_status'];
                                      if ($status == '1') {
  ...
  <script src="../js/displayDoctor.js"></script>
</body>
