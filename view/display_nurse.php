...
$nurse_id = isset($_REQUEST['nurse_id']) ? base64_decode($_REQUEST['nurse_id']) : '';

$result = $nurse_object->get_SpecificNurse($nurse_id);
...
<body>
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            <div class="card-header text-center bg-dark text-white">
              <i class="fa fa-user-nurse fa-3x fa-pull-left"></i> <i class="fa fa-edit fa-3x fa-pull-left"></i> <span style="font-size:28px; letter-spacing:5px;" style="color:#FFF;"><b>Update Nurse Details</b></span>
            </div>
            <div class="card-body">
              <!--Reg Form Start-->
              <form id="editNurseForm" action="../controller/staff_controller.php?status=update_nurse&nurse_id=<?php echo $nurse_id; ?>" method="post">

                <h4>Profile Status - <?php $status = $row['nurse_status'];
                                      if ($status == '1') {
  ...
  <script src="../js/displayNurse.js"></script>
</body>
