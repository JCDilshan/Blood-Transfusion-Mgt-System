...
$grp_id = isset($_REQUEST['grp_id']) ? base64_decode($_REQUEST['grp_id']) : '';

include('../model/blood_model.php');
$bloodGrp_object = new Blood_Grp($conn);
$result = $bloodGrp_object->give_SpecificGroup($grp_id);
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="../controller/blood_controller.php?status=updateGrp&grp_id=<?php echo $grp_id; ?>" method="post">
