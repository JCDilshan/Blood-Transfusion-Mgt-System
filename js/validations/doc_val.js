$(document).ready(function (e) {
  ...
  $("#mng_docTB").on("click", ".BlockConf", function () {
    var loc = $(this).attr("href");

    swal(
      {
        title: "Are you sure You Want Block This Doctor ?",
        text: "",
        type: "warning",
  ...
  //////////////////////// Remove confirmation /////////////////////
  $("#mng_docTB").on("click", ".RemoveConf", function () {
    var loc = $(this).attr("href");

    swal(
      {
        title: "Are you sure You Want Remove This Doctor ?",
        text: "",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
  ...
  //////////////////////// Doctor existance check by ajax ///////////////////////
  $("#nic").on("keyup", function () {
    var nic = $(this).val();

    if (nic != "" || nic != null) {
      $.ajax({
        url: "../controller/staff_controller.php?status=doctor_search",
        type: "POST",
        data: { nic: nic },
        success: function (data) {
          if (data == "fail") {
            $("#doc_res").html("Doctor Already Added*");
  ...
  $("#addDoc_Form").on("submit", function () {
