$(document).ready(function (e) {
  ...
  $("#mng_memTB").on("click", ".BlockConf", function () {
    var loc = $(this).attr("href");

    swal(
      {
        title: "Are you sure You Want Block This Member ?",
        text: "",
        type: "warning",
  ...
  //////////////////////// Remove confirmation /////////////////////
  $("#mng_memTB").on("click", ".RemoveConf", function () {
    var loc = $(this).attr("href");
  ...
  //////////////////////// Member existance check by ajax ///////////////////////
  $("#nic").on("keyup", function () {
    var nic = $(this).val();

    if (nic != "" || nic != null) {
      $.ajax({
        url: "../controller/staff_controller.php?status=mem_search",
        type: "POST",
        data: { nic: nic },
        success: function (data) {
          if (data == "fail") {
            $("#mem_res").html("Member Already Added*");
  ...
  $("#addMem_Form").on("submit", function () {
