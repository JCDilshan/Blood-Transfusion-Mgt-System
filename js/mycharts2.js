$(document).ready(function (e) {
  ...
  var TotalBlood_data2020 = [];
  var AcceptBlood_data2020 = [];
  var RejectBlood_data2020 = [];
  ...
  function Chart1_ajax() {
    $.ajax({
      ...
      success: function (res) {
        if (res[0][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            TotalBlood_data2020.push(res[0][5][i]); //////////// [0] => Donated bloods , [5] => Current year, [i] => Month ///////////
          }
        }

        if (res[1][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            AcceptBlood_data2020.push(res[1][5][i]); //////////// [1] => Accepted bloods , [5] => Current year, [i] => Month ///////////
          }
        }

        if (res[2][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            RejectBlood_data2020.push(res[2][5][i]); //////////// [0] => Rejected bloods, [5] => Current year, [i] => Month ///////////
          }
        }
      },
    });
  ...
  var AddedBlood_data2020 = [];
  var IssuedBlood_data2020 = [];
  var ExpiredBlood_data2020 = [];
  ...
  function Chart2_ajax() {
    $.ajax({
      ...
      success: function (res) {
        if (res[0][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            AddedBlood_data2020.push(res[0][5][i]); //////////// [0] => Added bags , [5] => Current year, [i] => Month ///////////
          }
        }

        if (res[1][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            IssuedBlood_data2020.push(res[1][5][i]); //////////// [0] => Issued bags , [5] => Current year, [i] => Month ///////////
          }
        }

        if (res[2][0] != "Error") {
          for (i = 1; i <= 12; i++) {
            ExpiredBlood_data2020.push(res[2][5][i]); //////////// [0] => Expired bags , [5] => Current year, [i] => Month ///////////
          }
        }
      },
    });
